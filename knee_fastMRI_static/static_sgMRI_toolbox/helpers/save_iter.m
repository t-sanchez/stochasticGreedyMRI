...
selected_volumes{counter_mask} = batch;
...
if  (rate_grid_save <= size(rate_grid,2) )
    if ( rate_i > rate_grid(rate_grid_save) ) 
        ...
        file_name = [results_folder,'/',algo,(sprintf('_rate=%.3f',rate_i_attained)), ...
            '_size=',num2str(nx),'_',num2str(ny),'_',num2str(ntr),'_orientation=', ...
            orientation,'_samplingGreedy=',sampling, '_metric=',metric,'_GREEDY.mat'];  
...
file_name = [results_folder,'/',algo, '_size=',num2str(nx),'_',num2str(ny),'_', ...
     num2str(ntr), '_orientation=',orientation,'_samplingGreedy=',sampling, '_metric=',metric,'_GREEDY.mat'];     
